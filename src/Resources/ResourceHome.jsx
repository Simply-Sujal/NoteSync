            ...
            <div className='w-full bg-[#ebf3ff] h-screen bg-hero flex flex-col justify-between'>
                <div className='grid md:grid-cols-2 max-w-[1240px] mx-auto'>
                    <div className='flex flex-col justify-center md:items-start w-full px-2 mt-20 md:pt-8'>
                        <h1 className='text-3xl md:text-6xl font-bold'>Download Resources<span className='text-green-500'> using College Year</span></h1>
                        <p className='py-3 text-[18px]'>We provide the easiest and simplest option to download study materials for the upcoming semester.</p>
